...
from .lerobot_dataset import LeRobotDatasetV3
...
class OnlineBuffer(torch.utils.data.Dataset):
    ...
    Follows the protocol of LeRobotDatasetV3 as much as is required to have it be used by the online training
    loop in the same way that a LeRobotDatasetV3 would be used.
    ...
    def __init__(
        ...
        Args:
            ...
            delta_timestamps: Same as the delta_timestamps concept in LeRobotDatasetV3. This is internally
...
def compute_sampler_weights(
    offline_dataset: LeRobotDatasetV3,
    ...
    Args:
        offline_dataset: The LeRobotDatasetV3 used for offline pre-training.
