...
python lerobot/scripts/eval.py \
  --policy.path="/gscratch/amath/shirui/depi/outputs/train/2025-11-14/19-44-40_DePi0_meta_world/pretrained_model" \
  --env.type=metaworld \
  --env.task=medium \
  --eval.batch_size=1 \
  --eval.n_episodes=1
...
from lerobot.common.constants import ACTION, DONE, OBS_STR, REWARD
from lerobot.common.envs.factory import make_env, make_env_pre_post_processors
...
from lerobot.common.processor import PolicyAction, PolicyProcessorPipeline
